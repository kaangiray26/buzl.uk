<template>
    ...
    <p class="card-text" style="color: var(--text-general);font-family: Inter, sans-serif;">
        During this time I've worked on a lot of projects that I didn't believe I could finish. There was just
        one path on my mind: Find what you don't know and go all the way towards it. So, I followed the path until I was
        able to bring those dreams into my world.
    </p>
    <hr class="text-white" />
    <p class="card-text" style="color: var(--text-general);font-family: Inter, sans-serif;">
        Some technologies I like to use:
    </p>
    <div class="row gx-0 gy-0 mb-0">
        <div class="col">
            <div class="card">
